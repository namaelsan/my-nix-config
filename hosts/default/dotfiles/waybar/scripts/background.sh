...
sed -i "s/@define-color backgroundlight .*/@define-color backgroundlight $(cat ~/.cache/wal/colors | sed -n '1p')/;" "$WAYBAR_STYLE"
sed -i "s/@define-color backgrounddark .*/@define-color backgrounddark $(cat ~/.cache/wal/colors | sed -n '2p')/;" "$WAYBAR_STYLE"
sed -i "s/@define-color textcolor1 .*/@define-color textcolor1 $(cat ~/.cache/wal/colors | sed -n '5p')/;" "$WAYBAR_STYLE"
sed -i "s/@define-color textcolor2 .*/@define-color textcolor2 $(cat ~/.cache/wal/colors | sed -n '6p')/;" "$WAYBAR_STYLE"
