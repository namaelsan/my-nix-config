{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-bfea172e-0567-477d-8bb1-805f43cea35c" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,12,24,21,43,50.906";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."bfea172e-0567-477d-8bb1-805f43cea35c" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "bfea172e-0567-477d-8bb1-805f43cea35c";
      ...
      "katerc"."KTextEditor::Search"."Search History" = "steam,shell";
      ...
      "kwinrc"."Desktops"."Id_1" = "2a38d317-ed3d-43ff-8f8b-0b0196190071";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/1e61ed63-f008-55e9-84bb-4ab5ab23a7f7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/4bfe1ca3-67d5-59f7-9c86-74832bed3332"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/acbfc1eb-2033-5175-ac10-4d87bfe764a0"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/b7444712-e925-5824-b2c9-5affb45556be"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 695;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-2-Splitter" = 856;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,738,204";
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorColumn" = 37;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorLine" = 32;
